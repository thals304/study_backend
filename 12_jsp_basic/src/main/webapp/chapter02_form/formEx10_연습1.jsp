...
<!DOCTYPE html>
<!-- 24.04.11 time 11:48-11:59
	today 소감문
	체크박스의 내용이 한 개만 있을 때는 문자열 배열이 아닌 그냥 문자열로 받아도 된다는 점!
	그리고 결과물 출력할 때 filedset으로 묶어주면 좀 더 깔끔하다는 점!
	을 배우게 되었다.
 -->
<html>
<head>
...
<body>
	...
	<form action="formEx10Pro_연습1정답.jsp" method="post">
		<fieldset>
