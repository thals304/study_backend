...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = -676755478L;

    public static final QMember member = new QMember("member1");

    public final StringPath activeYn = createString("activeYn");

    public final DatePath<java.time.LocalDate> birthAt = createDate("birthAt", java.time.LocalDate.class);
    ...
    public final DatePath<java.time.LocalDate> joinAt = createDate("joinAt", java.time.LocalDate.class);
